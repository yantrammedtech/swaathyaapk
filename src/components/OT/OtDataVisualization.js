...
// import { VictoryChart, VictoryLine, VictoryTheme, VictoryAxis, VictoryLegend } from 'victory-native'; // Updated to use multiple lines
    ...
    <View style={[styles.tooltip, { left: verticalLinePosition }]}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navButton}>
          <IconFont name="home" size={24} color="#4A90E2" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navButton}>
          <IconFont name="calendar" size={24} color="#4A90E2" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.navButton}>
          <IconFont name="list" size={24} color="#4A90E2" />
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
