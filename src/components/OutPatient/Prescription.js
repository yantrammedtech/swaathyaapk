...
console.log("response==============",response)
    if (response.message === "success") {
      setMedicineList(response.prescriptions);
    }
  };
  ...
  function updateLatestData(_text) {
    setRender(!render);
  }
            ...
            <View style={styles.medicineInfo}>
              ...
              <View style={styles.detailRow}>
                <Text style={styles.detailText}>
                  ...
                  <Text style={styles.boldText}>
                    {" "}
                    {medicine.medicineDuration} day{medicine.medicineDuration > 1 ? "s" : ""}
                  </Text>
                </Text>
              </View>
              ...
              <View style={styles.detailRow}>
                <Text style={styles.detailText}>
                  No. of Doses:
                  <Text style={styles.boldText}>
                    {medicine.meddosage} {medicine.doseUnit}
                  </Text>
                </Text>
              </View>
              <View style={styles.detailRow}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailText}>
                  Time:{" "}
                  <Text style={styles.boldText}>{formatDate(medicine.addedOn)}</Text>
                </Text>
              </View>
            </View>
