...
const VitalCard = ({ visible, onClose, onSave }) => {
  ...
  const handleChange = (field, value) => {
    ...
    if (field === "oxygen") {
      ...
      if (updatedValue > 200 || updatedValue < 50) {
        ...
        newErrors.bpH =
          "High BP value should be greater than the low BP value.";
      } else {
  ...
  const handleSavePress = async () => {
    ...
    if (!vitals.oxygen && !vitals.bpH && !vitals.bpL && !vitals.temperature && !vitals.pulse && !vitals.respiratoryRate){
      Alert.alert("Validation Error", "Please fill atleast one field");
      return;
    } 
    ...
    const wardName = currentPatient?.wardID
      ? wardList.find((ward) => ward.id == currentPatient.wardID)?.name
      : "";
    const patientAge = calculateAge(user.dob);
    // console.log("oxytime===",vitals.time, vitals.temperatureTime)
    console.log(
      "object",
      vitals.oxygenTime ? convertTimeToISO(vitals.time) : ""
    );
    const response = await authPost(
      `vitals/${user.hospitalID}/${currentPatient.id}`,
      {
        ...
        respiratoryRateTime: vitals.respiratoryRateTime
    ...
    console.log("response vitals===vitals=", vitals);
        ...
        <ScrollView contentContainerStyle={styles.container}>
          <View style={styles.inputContainer}>
            ...
            <TextInput
              style={[
                styles.input,
                vitals.errors.oxygen ? styles.inputError : null,
              ]}
              value={vitals.oxygen}
          ...
          <View style={styles.bpContainer}>
            <View style={styles.bpInputContainer}>
              ...
              <TextInput
                style={[
                  styles.bpInput,
                  vitals.errors.bpH ? styles.inputError : null,
                ]}
                value={vitals.bpH}
            ...
            <View style={styles.bpInputContainer}>
              ...
              <TextInput
                style={[
                  styles.bpInput,
                  vitals.errors.bpL ? styles.inputError : null,
                ]}
                value={vitals.bpL}
          ...
          <View style={styles.bpContainer}>
            <View style={styles.bpInputContainer}>
              ...
              <TextInput
                style={[
                  styles.bpInput,
                  vitals.errors.temperature ? styles.inputError : null,
                ]}
            ...
            <View style={styles.bpInputContainer}>
              ...
              <TextInput
                style={[
                  styles.bpInput,
                  vitals.errors.pulse ? styles.inputError : null,
                ]}
                value={vitals.pulse}
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              style={[
                styles.input,
                vitals.errors.respiratoryRate ? styles.inputError : null,
              ]}
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.timeInputContainer}>
              <TextInput
                style={[
                  styles.input,
                  vitals.errors.time ? styles.inputError : null,
                  { flex: 1 },
